                ...
                <div className="flex items-center justify-between mt-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {isLoading ? (
                      <button
                        disabled
                        className="w-7 h-7 flex items-center justify-center bg-button-inverted text-fg-on-color rounded-[7px] transition-all cursor-not-allowed"
                      >
                        <Spinner size="sm" />
                      </button>
                    ) : inputValue.trim() ? (
                      <button
                        onClick={() => sendMessage()}
                        className="w-7 h-7 flex items-center justify-center bg-button-inverted text-fg-on-color rounded-[7px] hover:bg-button-inverted-hover transition-all"
                      >
