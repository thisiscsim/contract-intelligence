...
import { Plus, Copy, ListPlus, SquarePen, Download, RotateCcw, ThumbsUp, ThumbsDown, Paperclip, Scale, CornerDownLeft, X } from "lucide-react";
                        ...
                        <div className="flex items-end justify-between pl-[10px] pr-[10px] pb-[10px]">
                          ...
                          <div className="flex items-center gap-2">
                            {isChatLoading ? (
                              ...
                              <button onClick={() => sendMessage()} disabled={!chatInputValue.trim()} className="h-[28px] px-[8px] flex items-center justify-center bg-button-inverted text-fg-on-color rounded-[6px] hover:bg-button-inverted-hover transition-all disabled:opacity-40 disabled:cursor-not-allowed">
